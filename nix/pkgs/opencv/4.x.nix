{
  ...
  ippicv = {
    ...
    in
      ...
      then {${name "lnx_intel64"} = "606a19b207ebedfe42d59fd916cc4850";}
      else if effectiveStdenv.hostPlatform.system == "i686-linux"
      then {${name "lnx_ia32"} = "ea08487b810baad2f68aca87b74a2db9";}
      else if effectiveStdenv.hostPlatform.system == "x86_64-darwin"
      then {${name "mac_intel64"} = "14f01c5a4780bfae9dde9b0aaf5e56fc";}
